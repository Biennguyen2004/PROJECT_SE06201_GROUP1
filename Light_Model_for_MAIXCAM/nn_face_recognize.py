...
# see https://github.com/sipeed/maixpy/blob/main/projects/app_face_recognizer
# and https://wiki.sipeed.com/maixpy/doc/zh/vision/face_recognition.html
...
def main(disp):
    ...
    while not app.need_exit():
        ...
        for obj in faces:
            ...
            if learn and obj.class_id == 0: # unknown face, we add it learn and obj.class_id == 0
                #name = f"id_{learn_id}"
                name = "Tung"
                print("add face:", name)
